...
namespace TheCloudShopsMetaData
{
    ...
    class Program
    {
        //update the connection string from the keys section on your storage account. The account was built in previous demos
        ...
        static async Task Run()
        {
            ...
            //upload orders with metadata in the container
            ...
            //Search for an order by customer Woodrow 
        ...
        static void GetContainerMetadata(BlobServiceClient blobServiceClient)
        {
            ...
            //reading properties / metadata saved earlier
        ...
        /// <summary>
        /// Build a container with metadata
        /// </summary>
        /// <param name="blobServiceClient"></param>
        /// <returns></returns>
        static  async Task<BlobContainerClient> BuildContainer( BlobServiceClient blobServiceClient)
        {
            ...
            // Create a container if it does not exits
        ...
        /// <summary>
        /// Create customer file with metadata and indexed prop
        /// </summary>
